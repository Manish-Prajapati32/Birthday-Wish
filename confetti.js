...
(function () {
    var COLORS, Confetti, NUM_CONFETTI, PI_2, canvas, context, drawCircle, i, range, resizeWindow, xpos;
    ...
    // Global function to start confetti
    window.startConfetti = function () {
        var confetti = [];
        resizeWindow();
        for (var i = 1; i <= NUM_CONFETTI; i++) {
